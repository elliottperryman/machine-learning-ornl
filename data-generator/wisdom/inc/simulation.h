...
void gen_synth_pulse(double amp, short* wf, default_random_engine &gen, uniform_real_distribution<double> &dist); //generates a synthetic pulse shape where a semi-gaussian current pulse is integrated and run through a CR-(RC)^2 shaper
void add_pileup(double amp, short* wf, default_random_engine &gen, uniform_real_distribution<double> &dist); //generates a synthetic pulse shape where a semi-gaussian current pulse is integrated and run through a CR-(RC)^2 shaper
