...
cb = keras.callbacks.ModelCheckpoint("weights-5k-{epoch:02d}-{acc:.2f}.hdf5", monitor='acc', verbose=0, save_best_only=False, save_weights_only=True, mode='auto', period=10)
model = ResNet50(input_shape = (400, 1), classes = 2)
model.compile(optimizer='adamax', loss='binary_crossentropy', metrics=['accuracy'])
gen = DataReader(numBeforeRepeated=5, batch_size=16, edgeCases=False)
model.fit_generator(gen, epochs = 5000, callbacks=[cb])
model.save('5k_run.h5')
