...
model = load_model('junk4.h5')

model.compile(optimizer='adam', loss='binary_crossentropy', metrics=['accuracy'])
#val = ValidationGenerator(numBeforeRepeated=10) 

gen = DataReader(numBeforeRepeated=10, batch_size=32)
model.fit_generator(gen, epochs = 1000)
model.save('junk1.h5')
...
gen = DataReader(numBeforeRepeated=1, batch_size=32)
model.fit_generator(gen, validation_data=val, epochs = 5, callbacks=[cb])
model.save('junk4.h5')
""";
